        ...
        $("#fileToUpload").change(function(){
          ...
          $('#formData').on("submit",function(e){
            ...
            if(submit==1){                                        //Propagate only if urls are valid
              ...
              img.append('w',WSUniqueId);                           //Therefore mentor Id is also sent
              $.ajax({
                type: 'POST',
                processData: false,
                contentType: false,
              ...
              if(dontAdd==0){                               //If any profiles were added
               ...
               $.ajax({                                     //data is sent to enter into the database
                  ...
                  url:'addWeeklyStoryToDb.php',
                  data:{formdata:data,i:imgPath,w:WSUniqueId},
                  async:false,
                  success:function(data){
                    alert("Record was succesfully inserted with Id:"+WSUniqueId);

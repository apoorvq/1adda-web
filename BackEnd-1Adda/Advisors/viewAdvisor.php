    ...
    <?php
        ...
        foreach($result as $document)
        {
          ...
          //img to delete from directory if edited.
            ...
            echo "<td><button idAdvisor=";
            echo $document['uniqueId'];
            echo " imgAdvisor= ";
            echo $img;
            echo " >Remove</button>";
            echo "<a href=editAdvisor.php?id=";                  //Edit button redirects to editMentor.php along with the id
    ...
    <script>
      $(document).ready(function(){
        ...
        function confirmDelete(elem) {
            ...
            if (r == true) {
              var id=elem.attr('idAdvisor');
              var img=elem.attr('imgAdvisor');
              elem.closest('tr').remove();                    //id and image of the mentor are sent to be deleted
              $.ajax({
                  url:'deleteAdvisor.php',
                  type:'Post',
                  data :{id,img},
                  success(){
                    alert('deleted');

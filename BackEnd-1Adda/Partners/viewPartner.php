    ...
    <?php
        ...
        foreach($result as $document)
        {
          ...
          //img to delete from directory if edited.
            ...
            echo "<td><button idPartner=";
            echo $document['uniqueId'];
            echo " imgPartner= ";
            echo $img;
            echo " >Remove</button>";
            echo "<a href=editPartner.php?id=";                  //Edit button redirects to editMentor.php along with the id
    ...
    <script>
      $(document).ready(function(){
        ...
        function confirmDelete(elem) {
            ...
            if (r == true) {
              var id=elem.attr('idMentor');
              var img=elem.attr('imgMentor');

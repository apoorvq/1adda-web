    ...
    <?php
        ...
        foreach($result as $document)
        {
          ...
          //img to delete from directory if edited.
            ...
            echo "<td><button idCareer=";
            echo $document['uniqueId'];
            echo " imgCareer= ";
            echo $img;
            echo " >Remove</button>";
            echo "<a href=editCareer.php?id=";                  //Edit button redirects to editMentor.php along with the id
    ...
    <script>
      $(document).ready(function(){
        ...
        function confirmDelete(elem) {
            ...
            if (r == true) {
              var id=elem.attr('idCareer');
              var img=elem.attr('imgCareer');
              elem.closest('tr').remove();                    //id and image of the mentor are sent to be deleted
              $.ajax({
                  url:'deleteCareer.php',
                  type:'Post',
                  data :{id,img},
                  success(){
                    alert('deleted');

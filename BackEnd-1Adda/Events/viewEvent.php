    ...
    <?php
        ...
        foreach($result as $document)
        {
          ...
          //img to delete from directory if edited.
            ...
            echo "<td><button idEvent=";
            echo $document['uniqueId'];
            echo " imgEvent= ";
            echo $img;
            echo " >Remove</button>";
            echo "<a href=editEvent.php?id=";                  //Edit button redirects to editMentor.php along with the id
    ...
    <script>
      $(document).ready(function(){
        ...
        function confirmDelete(elem) {
            ...
            if (r == true) {
              var id=elem.attr('idEvent');
              var img=elem.attr('imgEvent');

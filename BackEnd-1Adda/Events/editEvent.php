<?php
  ...
  $rows = $manager->executeQuery('backEndData.Events', $query);
  foreach($rows as $row){
    foreach($row as $r=>$v){
      $Arr[$r]=$v;
    }
    ...
    <div id="main">
         <div id="addMentor" style="border:2px solid black; margin :20px;padding:20px;">
            <form   method="post" enctype="multipart/form-data" id="formData">
                ...
                <p>Date</p>
                <input name="Date"  id="Date" value="<?php echo $Arr['Industry']?>"></input>
                <p>Publisher</p>
                <textarea name="Publisher"  ><?php echo $Arr['Date']?></textarea>
                <p>Venue</p>
                <textarea name="Venue"  ><?php echo $Arr['Venue']?></textarea>
              </br></br>

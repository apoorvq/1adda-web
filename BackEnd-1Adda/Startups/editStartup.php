<?php
  ...
  $rows = $manager->executeQuery('backEndData.Startups', $query);
  foreach($rows as $row){
    foreach($row as $r=>$v){
      $Arr[$r]=$v;
    }
    ...
    <div id="main">
         <div id="addMentor" style="border:2px solid black; margin :20px;padding:20px;">
            <form   method="post" enctype="multipart/form-data" id="formData">
                ...
                <input required type="file" name="image" id="fileToUpload" ></input>
              </br></br>
                ...
                <textarea required name="Key_Area"  ><?php echo $Arr['Key_Area']?></textarea>
                <p>Launch Date</p>
                <input name="LaunchDate"  id="LaunchDate" value= "<?php echo $Arr['LaunchDate']?>"></input>
                <p>Industry</p>
                </br>
                <textarea required name="Industry"  ><?php echo $Arr['Industry']?></textarea>
              </br></br>

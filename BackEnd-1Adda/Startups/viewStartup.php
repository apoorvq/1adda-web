    ...
    <?php
        ...
        foreach($result as $document)
        {
          ...
          //img to delete from directory if edited.
            ...
            echo "<td><button idStartup=";
            echo $document['uniqueId'];
            echo " imgStartup= ";
            echo $img;
            echo " >Remove</button>";
            echo "<a href=editStartup.php?id=";                  //Edit button redirects to editMentor.php along with the id
    ...
    <script>
      $(document).ready(function(){
        ...
        function confirmDelete(elem) {
            ...
            if (r == true) {
              var id=elem.attr('idStartup');
              var img=elem.attr('imgStartup');
              elem.closest('tr').remove();                    //id and image of the mentor are sent to be deleted
              $.ajax({
                  url:'deleteStartup.php',
                  type:'Post',
                  data :{id,img},
                  success(){
                    alert('deleted');

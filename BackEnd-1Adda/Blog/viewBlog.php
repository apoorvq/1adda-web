    ...
    <?php
        ...
        foreach($result as $document)
        {
          ...
          //img to delete from directory if edited.
            ...
            echo "<td><button idBlog=";
            echo $document['uniqueId'];
            echo " imgBlog= ";
            echo $img;
            echo " >Remove</button>";
            echo "<a href=editBlog.php?id=";                  //Edit button redirects to editMentor.php along with the id
    ...
    <script>
      $(document).ready(function(){
        ...
        function confirmDelete(elem) {
            ...
            if (r == true) {
              var id=elem.attr('idBlog');
              var img=elem.attr('imgBlog');
